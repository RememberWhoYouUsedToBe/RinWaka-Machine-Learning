...
class data:
    ...
    def __init__(self):
        ...
        y_list = [
            1.0 + 0.5*1 + 1.0*2,    # 1.0*1 + 0.5*1 + 1.0*2 = 4.0
            1.0 + 0.5*2 + 1.0*4,    # 1.0*1 + 0.5*2 + 1.0*4 = 6.0
            1.0 + 0.5*3 + 1.0*1,    # 1.0*1 + 0.5*3 + 1.0*1 = 4.5
            1.0 + 0.5*4 + 1.0*3,    # 1.0*1 + 0.5*4 + 1.0*3 = 6.0
            1.0 + 0.5*5 + 1.0*5,    # 1.0*1 + 0.5*5 + 1.0*5 = 8.5
            1.0 + 0.5*6 + 1.0*2,    # 1.0*1 + 0.5*6 + 1.0*2 = 6.0
            1.0 + 0.5*7 + 1.0*6,    # 1.0*1 + 0.5*7 + 1.0*6 = 8.5
            1.0 + 0.5*8 + 1.0*3,    # 1.0*1 + 0.5*8 + 1.0*3 = 6.0
            1.0 + 0.5*9 + 1.0*5,    # 1.0*1 + 0.5*9 + 1.0*5 = 8.5
            1.0 + 0.5*10 + 1.0*4    # 1.0*1 + 0.5*10 + 1.0*4 = 10.0
        ]
